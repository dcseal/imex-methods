...
plt.plot( np.log(dt), np.log( er[0,:,0] ), 'ro' )
plt.plot( np.log(dt), np.log( er[1,:,0] ), 'go' )
plt.plot( np.log(dt), np.log( er[2,:,0] ), 'bo' )
plt.plot( np.log(dt), np.log( er[0,:,1] ), 'ro' )
plt.plot( np.log(dt), np.log( er[1,:,1] ), 'go' )
plt.plot( np.log(dt), np.log( er[2,:,1] ), 'bo' )
